...
def validate_single_code_t1mer(ctx: dict):
    return _validate_single_code(ctx, game_label="T1mer")
...
def _validate_single_code(ctx: dict, game_label: str):
    ...
    for code in numeric:
        ...
        for it in items:
            ...
            # Only enforce quiz if this player has quizRequired=true in type.<game>
